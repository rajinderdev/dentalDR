<div class="flex items-center justify-center">
    <button type="button" onclick="viewSteps('{{ $treatment->TreatmentTypeID }}', '{{ addslashes($treatment->Title) }}')"
        ...
        <svg class="w-7 h-7" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 6v12m-6-6h12"/></svg>Add Step
    </button>
    <button onclick="editTreatment('{{ $treatment->TreatmentTypeID }}')"
