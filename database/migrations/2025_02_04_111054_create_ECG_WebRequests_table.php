...
return new class extends Migration
{
    ...
    {
        Schema::create('ECG_WebRequests', function (Blueprint $table) {
            $table->uuid('RequestID')->default('newid()');
            ...
            $table->primary(['RequestID'], 'pk_ecg_webrequests');
        });
    }
    ...
    {
        Schema::dropIfExists('ECG_WebRequests');
    }
};
