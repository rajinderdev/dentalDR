 ...
 * Class SMSSituation
 * 
 * @property string $SMSSituationID
 ...
 * @package App\Models
 */
class SMSSituation extends Model
{
	protected $table = 'SMSSituations';
	protected $primaryKey = 'SMSSituationID';
	...
	protected static function boot()
	{
		...
		static::creating(function ($model) {
			if (empty($model->SMSSituationID)) {
				$model->SMSSituationID = (string) Str::uuid(); // Auto-generate UUID
			}
		});
	}
	...
	protected function id(): Attribute
    {
		return Attribute::make(
        	get: fn (mixed $value, array $attributes) => $attributes['SMSSituationID'],
		);
    }
}
