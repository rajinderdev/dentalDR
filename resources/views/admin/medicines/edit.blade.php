...
<div class="bg-white rounded-lg shadow-sm p-4 md:p-6">
    ...
    <h1 class="text-xl md:text-2xl font-bold text-gray-800 mb-4 md:mb-6">Edit Medicine</h1>
            ...
            <div class="space-y-3 md:space-y-4">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" id="GenericName" name="GenericName" value="{{ $medicine->GenericName }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <textarea id="Contraindications" name="Contraindications" rows="3"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
                                  placeholder="Enter contraindications">{{ $medicine->Contraindications }}</textarea>
                    </div>
                    {{-- Interactions --}}
                    <div>
                        ...
                        <textarea id="Interactions" name="Interactions" rows="3"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
                                  placeholder="Enter interactions">{{ $medicine->Interactions }}</textarea>
                    </div>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {{-- Adverse Effects --}}
                    <div>
                        ...
                        <textarea id="AdverseEffects" name="AdverseEffects" rows="3"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
                                  placeholder="Enter adverse effects">{{ $medicine->AdverseEffects }}</textarea>
                    </div>
                    {{-- Overdose Management --}}
                    <div>
                        ...
                        <textarea id="OverdozeManagement" name="OverdozeManagement" rows="3"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
                                  placeholder="Enter overdose management">{{ $medicine->OverdozeManagement }}</textarea>
                    </div>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {{-- Precautions --}}
                    <div>
                        ...
                        <textarea id="Precautions" name="Precautions" rows="3"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
                                  placeholder="Enter precautions">{{ $medicine->Precautions }}</textarea>
                    </div>
                    {{-- Patient Alerts --}}
                    <div>
                        ...
                        <textarea id="PatientAlerts" name="PatientAlerts" rows="3"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
                                  placeholder="Enter patient alerts">{{ $medicine->PatientAlerts }}</textarea>
                    </div>
                </div>
                <div class="grid grid-cols-1 gap-4">
                    ...
                    <div>
                        ...
                        <textarea id="OtherInfo" name="OtherInfo" rows="3"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
                                  placeholder="Enter other information">{{ $medicine->OtherInfo }}</textarea>
                    </div>
                </div>
            </div>
        </div>
...
$('#editMedicineForm').on('submit', function(e) {
    ...
    if ($(this).valid()) {
        ...
        $.ajax({
            url: "{{ route('admin.medicines.update', $medicine->DrugId) }}",
            type: "POST",
            data: formData,
            contentType: false,
            cache: false,
            ...
            error: function(xhr) {
                let errorMessage = 'An error occurred while updating medicine.';
                if (xhr.responseJSON) {
