...
<div class="bg-white rounded-lg shadow-sm p-4 md:p-6">
    ...
    <h1 class="text-xl md:text-2xl font-bold text-gray-800 mb-4 md:mb-6">Add New Item</h1>

    <form id="createLookupForm" class="space-y-6">
        @csrf
...
$('#createLookupForm').on('submit', function(e) {
    e.preventDefault();
    if ($(this).valid()) {
