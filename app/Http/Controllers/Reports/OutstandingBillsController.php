...
class OutstandingBillsController extends Controller
{
    public function index(Request $request)
    {
        ...
        $service = app(\App\Services\Reports\OutstandingBillsService::class);
        $data = $service->getOutstandingBills($filters);
