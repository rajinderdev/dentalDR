...
<div class="bg-white rounded-lg shadow-sm p-4 md:p-6">
    ...
    <form id="createClinicForm" enctype="multipart/form-data" class="space-y-6">
        @csrf
            ...
            <div class="space-y-3 md:space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="AuthenticationKey" name="AuthenticationKey" value=""
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
            ...
            <div class="space-y-3 md:space-y-4">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="FTPBackupServer" name="FTPBackupServer" value=""
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
                    ...
                    <div>
                        ...
                        <input type="text" id="FTPUserID" name="FTPUserID" value=""
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
                    ...
                    <div>
                        ...
                        <input type="password" id="FTPPassword" name="FTPPassword" value=""
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
            ...
            <div class="space-y-3 md:space-y-4">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="EmailHost" name="EmailHost" value=""
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
                    ...
                    <div>
                        ...
                        <input type="text" id="EmailPort" name="EmailPort" value=""
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
                    ...
                    <div>
                        ...
                        <input type="text" id="EmailUserid" name="EmailUserid" value=""
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
                    ...
                    <div>
                        ...
                        <input type="password" id="EmailPassword" name="EmailPassword" value=""
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
                ...
                <div>
                    ...
                    <div class="flex flex-col items-center">
                        ...
                        <div class="flex gap-2">
                            ...
                            <button type="button" onclick="removelogo()" class="px-3 py-1.5 bg-red-500 text-white text-sm rounded-lg hover:bg-red-600 transition-colors hidden" id="removeLogoBtn">
                                Remove
                            </button>
                        </div>
                ...
                <div>
                    ...
                    <div class="flex flex-col items-center">
                        ...
                        <div class="flex gap-2">
                            ...
                            <button type="button" onclick="removeLetterhead()" class="px-3 py-1.5 bg-red-500 text-white text-sm rounded-lg hover:bg-red-600 transition-colors hidden" id="removeLetterheadBtn">
                                Remove
                            </button>
                        </div>
...
$('#createClinicForm').on('submit', function(e) {
    e.preventDefault();
    if ($(this).valid()) {
        var formData = new FormData(this);
        $.ajax({
            url: "{{ route('admin.clinic.store') }}",
            type: "POST",
            data: formData,
            contentType: false,
            cache: false,
            ...
            error: function(xhr) {
                let errorMessage = 'An error occurred while creating clinic.';
                if (xhr.responseJSON) {
