...
return new class extends Migration
{
    ...
    {
        Schema::create('PatientTreatmentsPlanDetails', function (Blueprint $table) {
            $table->uuid('PatientTreatmentPlanDetailID');
            ...
            $table->primary(['PatientTreatmentPlanDetailID'], 'pk_patienttreatmenttypeplandetails');
        });
    }
    ...
    {
        Schema::dropIfExists('PatientTreatmentsPlanDetails');
    }
};
